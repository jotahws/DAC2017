                                ...
                                <c:choose>
                                    <c:when test="${(param.status == 'successDelete')}">
                                        <div class="col-md-8 alert alert-warning alert-dismissable">
                                            ...
                                            <p> <span class="glyphicon glyphicon-trash"></span> O cargo foi <strong>excluído</strong> com sucesso.</p>
                                        </div>
                                    </c:when>
                                            ...
                                            <c:forEach var="item" items="${lista}">
                                                <div role="tabpanel" class="tab-pane fade" id="${item.id}">
                                                    <form method="POST" action="CargoServlet?action=edit&idCargo=${item.id}">
                                                        ...
                                                        <div class="text-right">
                                                            <button onclick = "return confirm('Alterar os dados deste cargo?')" type="submit" id="btnSubmitCargo" class="btnSubmitCargo btn btn-primary">Salvar Alterações</button>  
