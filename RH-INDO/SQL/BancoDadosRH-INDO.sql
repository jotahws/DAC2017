...
ALTER TABLE Cargo CHARSET = UTF8 COLLATE utf8_general_ci;
ALTER TABLE Endereco CHARSET = UTF8 COLLATE utf8_general_ci;
ALTER TABLE Estado CHARSET = UTF8 COLLATE utf8_general_ci;
ALTER TABLE Cidade CHARSET = UTF8 COLLATE utf8_general_ci;
